    ...
    return (
        <div className="container">
            ...
            <section className="hero-section bf-hero">
                ...
                <p className="subtitle">{tRich('bf.hero.subtitle')}</p>
            ...
            <section>
                ...
                <div className="bf-pillars-grid">
                    <div className="bf-pillar-card">
                        ...
                        <p className="text-body">{tRich('bf.usp.banking.text')}</p>
                    </div>
                    <div className="bf-pillar-card">
                        <div className="bf-pillar-icon">
                        ...
                        <p className="text-body">{tRich('bf.usp.gonogo.text')}</p>
                    </div>
                    <div className="bf-pillar-card">
                        <div className="bf-pillar-icon">
                        ...
                        <p className="text-body">{tRich('bf.usp.protection.text')}</p>
                    </div>
                    <div className="bf-pillar-card">
                        <div className="bf-pillar-icon">
                        ...
                        <p className="text-body">{tRich('bf.usp.modes.text')}</p>
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div className="grid-4 bf-how-grid">
                    <ProcessStep number="01" title={t('bf.how.step1.title')} description={tRich('bf.how.step1.desc')} active />
                    <ProcessStep number="02" title={t('bf.how.step2.title')} description={tRich('bf.how.step2.desc')} />
                    <ProcessStep number="03" title={t('bf.how.step3.title')} description={tRich('bf.how.step3.desc')} />
                    <ProcessStep number="04" title={t('bf.how.step4.title')} description={tRich('bf.how.step4.desc')} />
                </div>
            </section>
            ...
            <section>
                ...
                <div className="bf-services-grid">
                    <div className="bf-service-card">
                        ...
                        <p className="text-body">{tRich('bf.services.banking.desc')}</p>
                    </div>
                    <div className="bf-service-card">
                        <div className="bf-service-icon">
                        ...
                        <p className="text-body">{tRich('bf.services.setup.desc')}</p>
                    </div>
                    <div className="bf-service-card">
                        <div className="bf-service-icon">
                        ...
                        <p className="text-body">{tRich('bf.services.residency.desc')}</p>
                    </div>
                    <div className="bf-service-card">
                        <div className="bf-service-icon">
                        ...
                        <p className="text-body">{tRich('bf.services.operations.desc')}</p>
                    </div>
                    <div className="bf-service-card">
                        <div className="bf-service-icon">
                        ...
                        <p className="text-body">{tRich('bf.services.realestate.desc')}</p>
                    </div>
                    <div className="bf-service-card">
                        <div className="bf-service-icon">
                        ...
                        <p className="text-body">{tRich('bf.services.wealth.desc')}</p>
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                {activeModel === 'referral' ? (
                    <div className="bf-model-content">
                        ...
                        <p className="text-body">{tRich('bf.models.referral.desc')}</p>
                    ...
                    <div className="bf-model-content">
                        ...
                        <p className="text-body">{tRich('bf.models.whitelabel.desc')}</p>
                        <div className="bf-model-flow">
                            <div className="bf-model-step">
                                <span className="bf-model-step-num">1</span>
            ...
            <section>
                ...
                <div className="bf-bounds-grid">
                    <div className="bf-bounds-col bf-bounds-do">
                        ...
                        <ul>
                            <li>{tRich('bf.bounds.do.item1')}</li>
                            <li>{tRich('bf.bounds.do.item2')}</li>
                            <li>{tRich('bf.bounds.do.item3')}</li>
                            <li>{tRich('bf.bounds.do.item4')}</li>
                        </ul>
                    </div>
                    <div className="bf-bounds-col bf-bounds-dont">
                        ...
                        <ul>
                            <li>{tRich('bf.bounds.dont.item1')}</li>
                            <li>{tRich('bf.bounds.dont.item2')}</li>
                            <li>{tRich('bf.bounds.dont.item3')}</li>
                            <li>{tRich('bf.bounds.dont.item4')}</li>
                        </ul>
                    </div>
                </div>
            </section>
                    ...
                    {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                        <div key={i} className={`bf-faq-item ${openFaq === i ? 'bf-faq-item--open' : ''}`}>
                            ...
                            {openFaq === i && (
                                ...
                                >
                                    <p className="text-body">{tRich(`bf.faq.a${i}`)}</p>
                                </div>
                            )}
                        </div>
                    ))}
