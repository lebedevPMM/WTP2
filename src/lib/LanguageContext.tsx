...
const translations: Record<string, Record<string, string>> = {
    ...
    ru: {
        ...
        'partnersPage.qual.desc': 'Оптимизировано для банков и регуляторов, а не для «скорости любой ценой». Структура, которая проходит комплаенс сегодня и выдерживает аудит завтра.',
        ...
        // Form Consent
        'form.consent.prefix': 'Я согласен на обработку персональных данных в соответствии с',
