// Generate 18 WTP LinkedIn lead-magnet PDFs for May 2026 campaign.
// Data: ./lead-magnets-data-may.mjs
...
//   ~/Desktop/WTP-DM-materials-may/WTP-LM-{id}-v1.pdf  (delivery folder)

import puppeteer from 'puppeteer';
import path from 'path';
import { fileURLToPath } from 'url';
import fs from 'fs';
import { docs } from './lead-magnets-data-may.mjs';

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const outDir = path.join(__dirname, '..', 'dist', 'dm-materials-may');
...
(async () => {
  ...
  console.log(`\nGenerating ${docs.length} WTP lead-magnet PDFs (May 2026 campaign)...`);
  ...
  const desktopDir = path.join(process.env.HOME, 'Desktop', 'WTP-DM-materials-may');
