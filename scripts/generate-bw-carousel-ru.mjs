#!/usr/bin/env node
/**
 * WTP × BW — Карусель «Регуляторная карта 2025» (RU-версия с пояснениями терминов)
 * 8 кадров × 1080×1080, dark theme, IBM Plex Serif + Inter + IBM Plex Mono
 *
 * Отличие от generate-bw-carousel.mjs: вся терминология переведена на русский,
 * англицизмы вынесены в блок «термин» с коротким пояснением.
 *
 * Usage: node scripts/generate-bw-carousel-ru.mjs
 * Output: dist/wtp-bw-carousel-ru/slide-{01..08}.png
 */
...
const DIST = join(__dirname, '..', 'dist', 'wtp-bw-carousel-ru');
...
const slides = [
  // 1 — Обложка
  { page: '1 / 8', html: `
      <div class="meta">WTP · РЕГУЛЯТОРНАЯ КАРТА · ОАЭ 2025</div>
      <div class="rule"></div>
      <div class="headline h-cover">Регуляторная<br>карта 2025</div>
      <div class="subline" style="max-width: 820px">
        Что изменилось в ОАЭ за год — для семей с активами в нескольких странах.
      </div>
  ...
  { page: '2 / 8', num: '01', html: `
      <div class="meta">БАНКИ ОАЭ · 2025</div>
      <div class="rule"></div>
      <div class="headline h-card">Повторные запросы<br>о происхождении средств.</div>
      <div class="subline" style="max-width: 880px">
        Счета, открытые год-два назад, получают новые запросы. Особенно по компаниям в свободных экономических зонах.
      </div>
      <div class="termin">
        <div class="termin-tag">→ Термин</div>
        <div class="termin-body"><b>Source of Funds (SOF)</b> — документальное подтверждение происхождения денег: трудовой доход, продажа бизнеса, дивиденды, наследство. Банк требует периодически.</div>
      </div>
  ` },

  // 3 — Корпоративный налог
  { page: '3 / 8', num: '02', html: `
      <div class="meta">КОРПОРАТИВНЫЙ НАЛОГ 9 % · ОТЧЁТНЫЕ ПЕРИОДЫ</div>
      <div class="rule"></div>
      <div class="headline h-card">Первые отчётные<br>периоды закрыты.</div>
      <div class="subline" style="max-width: 880px">
        Компании, зарегистрированные до 2023 года, проходят настройку под требования экономического присутствия.
      </div>
      <div class="termin">
        <div class="termin-tag">→ Термин</div>
        <div class="termin-body"><b>Substance · экономическое присутствие</b> — реальный офис, сотрудники, расходы и операции в ОАЭ. Без них компанию считают формальной и снимают налоговые льготы.</div>
      </div>
  ` },

  // 4 — DIFC / ADGM
  { page: '4 / 8', num: '03', html: `
      <div class="meta">ФИНЦЕНТРЫ DIFC · ADGM · ХОЛДИНГИ</div>
      <div class="rule"></div>
      <div class="headline h-card">Холдинг без операций —<br>больше не приемлем<br>для банка.</div>
      <div class="subline" style="max-width: 880px">
        Двухуровневая структура — инструмент под конкретную задачу, а не универсальный шаблон.
      </div>
      <div class="termin">
        <div class="termin-tag">→ Термин</div>
        <div class="termin-body"><b>DIFC и ADGM</b> — финансовые зоны Дубая и Абу-Даби со своим английским правом и регулятором. Используются для серьёзных холдингов и фондов.<br><b>Холдинг</b> — компания, владеющая другими компаниями или активами без собственной операционной деятельности.</div>
      </div>
  ` },

  // 5 — Великобритания: режим non-dom
  { page: '5 / 8', num: '04', html: `
      <div class="meta">ВЕЛИКОБРИТАНИЯ · РЕЖИМ NON-DOM ОТМЕНЁН АПРЕЛЬ 2025</div>
      <div class="rule"></div>
      <div class="headline h-card">Налог теперь<br>по месту жительства,<br>а не по паспорту.</div>
      <div class="subline" style="max-width: 880px">
        У семей с активами и в Великобритании, и в ОАЭ появляются три новых вопроса.
      </div>
      <div class="termin">
        <div class="termin-tag">→ Термин</div>
        <div class="termin-body"><b>Non-dom (non-domiciled)</b> — британский налоговый режим, по которому иностранец, живущий в UK, не платил налог Великобритании с зарубежных доходов. С апреля 2025 отменён, заменён правилом резидентства.</div>
      </div>
  ` },
  ...
  { page: '6 / 8', num: '05', html: `
      ...
      <div class="rule"></div>
      <div class="headline h-card">Просрочка одного<br>документа тянет<br>блокировку счёта.</div>
      <div class="subline" style="max-width: 880px">
        Сезон отъездов требует другой подготовки, чем три года назад.
      </div>
      <div class="termin">
        <div class="termin-tag">→ Термин</div>
        <div class="termin-body"><b>Emirates ID</b> — удостоверение резидента ОАЭ. Привязано к визе, банковским счетам, аренде и страховке. Истечение тянет цепочку блокировок.</div>
      </div>
  ` },

  // 7 — Позиционирование
  { page: '7 / 8', html: `
      <div class="meta">WTP · ПЕРЕДАЧА КАПИТАЛА ЧЕРЕЗ БАНК</div>
      <div class="rule"></div>
      ...
      <div class="termin">
        <div class="termin-tag">→ Термин</div>
        <div class="termin-body"><b>Регуляторный периметр</b> — совокупность юрисдикций, банков, компаний и документов, в которых семья обязана соответствовать правилам. Если хотя бы один элемент рассинхронизирован — рушится вся конструкция.</div>
      </div>
  ` },
...
async function main() {
  ...
  console.log(`\n  Generating ${slides.length} BW carousel frames (RU)...\n`);
